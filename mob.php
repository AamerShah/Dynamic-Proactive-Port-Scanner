...
<br><br>
    <center><h3><span style="color:gray">Web based, DYNAMIC <span style="color:#9c353a">PORT SCANNER</span></span></h3>
<form method="post">
	...
	<input autocomplete="off" required placeholder="Ending Port..." type="text" name="endport" />&nbsp;<br />
